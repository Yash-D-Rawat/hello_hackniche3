...
function TextImage() {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className={`bg-blue text-white ${sidebarOpen ? 'w-64' : 'w-16'} transition-all duration-300 flex flex-col rounded-r-3xl overflow-hidden`}>
        <div className="p-4 flex items-center justify-between">
          <h1 className={`font-bold text-xl ${sidebarOpen ? 'block' : 'hidden'}`}>AI Image Chat</h1>
          <button 
        ...
        <div className="flex-1 overflow-y-auto">
          <nav className="px-4 py-2">
            <ul className="space-y-3">
              <li>
                <button className="w-full flex items-center px-3 py-2 rounded-md bg-blue text-white font-medium hover:bg-orange transition" onClick={() => (window.location.href = '/collaboration')}>
        ...
        <div className={`p-4 border-t border-blue ${sidebarOpen ? 'block' : 'hidden'}`}>
